    ...
    <div className="pt-16">
      ...
      <section className="min-h-screen relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div
            className="absolute bottom-40 left-20 w-40 h-40 bg-gradient-to-r from-emerald-400 to-teal-500 rounded-full opacity-20 animate-bounce"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute bottom-20 right-40 w-20 h-20 bg-gradient-to-r from-amber-400 to-orange-500 rounded-full opacity-20 animate-pulse"
            style={{ animationDelay: "2s" }}
          ></div>
          <div
            className="absolute top-1/2 left-1/4 w-16 h-16 bg-gradient-to-r from-purple-400 to-indigo-500 rounded-full opacity-20 animate-bounce"
                    ...
                    <div className="text-white">
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-4 z-10 relative">
                        ...
                        <a
                          ...
                          className="group flex items-center justify-center sm:justify-start space-x-3 text-white hover:text-white/80 transition-colors duration-300"
                        >
        ...
        <button
          onClick={prevSlide}
          className="hidden sm:block absolute left-8 top-1/2 transform -translate-y-1/2 z-20 p-3 bg-white/20 backdrop-blur-md text-white rounded-full hover:bg-white/30 transition-all duration-300 group"
        >
        ...
        <button
          onClick={nextSlide}
          className="hidden sm:block absolute right-8 top-1/2 transform -translate-y-1/2 z-20 p-3 bg-white/20 backdrop-blur-md text-white rounded-full hover:bg-white/30 transition-all duration-300 group"
        >
