...
const Pricing = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-pink-50 mt-18">
      {/* Hero Section */}
      <div className="px-3 sm:px-6 lg:px-8 pt-14 sm:pt-24 pb-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center">
            ...
            <div className="h-2 bg-pink-500 w-16 mx-4 rounded-full"></div>
            <div className="h-px bg-gray-300 w-24"></div>
          </div>
        </div>
      </div>
      ...
      {/* Pricing Section */}
      <div className="px-3 sm:px-6 lg:px-8 pb-16">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md">
              ...
              <div className="bg-pink-600 rounded-3xl p-8 text-center text-white shadow-2xl transform hover:scale-105 transition-all duration-300">
                ...
                <button className="w-full bg-white text-pink-600 py-3 rounded-xl text-lg font-bold hover:bg-gray-50 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                  GET STARTED NOW
                </button>
          ...
          <div className="space-y-8">
            ...
            <div className="grid gap-6">
              {[
                ...
                <div key={idx} className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-200">
      ...
      {/* What You'll Get */}
      <div className="px-3 sm:px-6 lg:px-8 pb-16">
        <div className="max-w-7xl mx-auto bg-white rounded-3xl p-10 shadow-xl border border-gray-100">
          <div className="text-center mb-10">
            <h3 className="text-4xl font-bold text-gray-900 mb-4">What You'll Get With This Course</h3>
      ...
      <div className="px-3 sm:px-6 lg:px-8 pb-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-orange-500 to-pink-600 rounded-3xl p-10 text-white">
            <h3 className="text-3xl font-bold mb-4">Ready to Start Your Export Management Journey?</h3>
